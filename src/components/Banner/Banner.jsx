      ...
      <SwiperSlide>
        <div className="bg-[url('https://i.ibb.co/fn9QB24/loginBG.jpg')] bg-center bg-no-repeat bg-cover">
            <div className="h-[600px] flex flex-col justify-center items-left text-white bg-[#1111117e] px-[20%] gap-3">
                <p data-aos="fade-up"  className="text-xl">FIND YOUR DREAM
                  
                </p>
                <h2  data-aos="fade-up" className="text-white text-4xl uppercase ">THE NEW <br />
                  BMW M SERIES <br />
                  SHADOW EDITION</h2>
                  <button  data-aos="zoom-in" className="btn w-fit px-6 rounded-sm bg-red-700 text-white hover:bg-red-600">See Details</button>
            </div>
        </div>
      </SwiperSlide>
      <SwiperSlide>
        <div className="bg-[url('https://i.ibb.co/hWNBCJZ/lamborghini-revuelto-100879502-h.jpg')] bg-center bg-no-repeat bg-cover">
            <div className="h-[600px] flex flex-col justify-center items-center text-white bg-[#1111117e] px-[20%] gap-4">
                <h2 data-aos="fade-up"  className="text-white text-4xl">LETS FIND YOUR PERFECT CAR</h2>
                <h3  data-aos="fade-up" >Choose from our ready stock or get directly imported from Japan & European countries</h3>
            </div>
        </div>
      </SwiperSlide>
      <SwiperSlide>
        <div className="bg-[url('https://i.ibb.co/Zc3CRTT/lamborghini-BG.jpg')] bg-center bg-no-repeat bg-cover">
            <div className="h-[600px] flex flex-col justify-center items-center text-white bg-[#1111117e] px-[20%] gap-6">
                ...
                <button data-aos="fade-up"  className="btn btn-warning rounded-sm">Buy Now</button>
            </div>
        </div>
      </SwiperSlide>

...
const ProductCard = ({ product }) => {
  ...
  return (
    ...
    data-aos-once="false" className="hover:animate-background rounded-xl p-0.5 shadow-xl transition hover:bg-[length:400%_400%] hover:shadow-sm hover:[animation-duration:_4s] max-w-7xl mx-auto w-full">
      <article className="flex glass bg-base-100 transition hover:shadow-xl ">
        ...
        <div className="flex flex-1 flex-col justify-between">
          <div className="border-s border-gray-900/10 p-4 sm:border-l-transparent sm:p-6">
            ...
            <p className="text-lg">Overall Rating : {ratings}</p>
            <p className="py-2">
            <Rating
              emptySymbol={
                <svg

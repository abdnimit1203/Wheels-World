    ...
    <div>
      ...
      <div className="bg-[url('https://i.ibb.co/MsLHvDz/lamborghini-aventador.jpg')] bg-center bg-no-repeat bg-cover">
        <div className="h-[600px] flex flex-col justify-center items-start text-white bg-[#1111117e] px-[10%] gap-6">
          <p>BEST AUTO SERVICES</p>
          <h2 className="text-white text-4xl text-shadow-lg shadow-indigo-500/50">
            Innovative Solutions <br /> For Automobile
          </h2>

          <button className="btn btn-ghost rounded-sm border border-white hover:border-white ">
            Learn more
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row">
        <div>
          <div className="bg-slate-900 hover:bg-slate-700 cursor-pointer flex sm:gap-10 text-white p-8">
        ...
        <div className="flex justify-around gap-6 items-center flex-1 py-6 bg-slate-900  text-gray-400 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 justify-between gap-8 py-14 px-10">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center">
          <div className="p-6 border-2 my-10 mx-4">

...
const UserProfile = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-purple-400 to-pink-600 py-20">
      <h2
        data-aos="fade-up"
        data-aos-duration="500"
        data-aos-mirror="true"
        data-aos-once="false"
        className="text-center font-bold pb-16 text-white text-2xl lg:text-5xl"
      >
      ...
      <div
        ...
        data-aos-mirror="true"
        data-aos-once="false"
        className="text-white  font-semibold flex flex-col justify-center items-center border border-white w-fit mx-auto p-10 rounded-3xl gap-6 py-10"
      >
        <img
          src={user?.photoURL}
          alt=""
